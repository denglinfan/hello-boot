...
public final class CodecUtils {
    ...
    public static byte[] or(byte[] data1, byte[] data2){
        if(data1.length != data2.length){
            throw new IllegalArgumentException("array length does NOT match, " + data1.length + " va " + data2.length);
        }
    ...
    public static byte[] and(byte[] data1, byte[] data2){
        if(data1.length != data2.length){
            throw new IllegalArgumentException("array length does NOT match, " + data1.length + " vs " + data2.length);
        }
    ...
    public static boolean equals(byte[] data1, byte[] data2){
        return Arrays.equals(data1,data1);
    }
