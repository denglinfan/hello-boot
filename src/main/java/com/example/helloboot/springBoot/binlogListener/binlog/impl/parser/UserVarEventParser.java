...
import com.example.helloboot.springBoot.binlogListener.binlog.impl.event.UserVarEvent;
import com.example.helloboot.springBoot.binlogListener.binlog.impl.variable.user.*;
